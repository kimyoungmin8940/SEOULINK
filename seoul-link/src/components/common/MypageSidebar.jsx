import { Bookmark, BriefcaseBusiness, CreditCard, MessageCircle, Pencil, Plus, Route, Sparkles, UserRound } from 'lucide-react';
...
export default function MypageSidebar({ activePath }) {
