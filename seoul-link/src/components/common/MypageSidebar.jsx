...
import { clearSurveyFlowStorage } from '../../utils/surveyFlowStorage';
...
export default function MypageSidebar({ activePath, bottomAction = 'map-course' }) {
    ...
    return <aside className="mypage-v3-sidebar">
        ...
        <a
            ...
            href={isRetestAction ? '/travel-info' : '/map-course?category=palace-culture'}
            onClick={isRetestAction ? clearSurveyFlowStorage : undefined}
        >
